...
@Configuration
@EnableNeo4jRepositories(basePackages = "uk.co.newcastle.rh.graphmaven.repository")
...
public class MyConfiguration {
    ...
    public SessionFactory sessionFactory() {
        ...
        return new SessionFactory(configuration(), "uk.co.newcastle.rh.graphmaven.domain");
    }
